...
class BackendAgendaModel
{
	...
	public static function deleteImage(array $ids)
	{
		...
		foreach($ids as $id)
		{
			...
			SpoonFile::delete($basePath . '/' . BackendModel::getModuleSetting('agenda', 'width1') . 'x' . BackendModel::getModuleSetting('agenda', 'height1') . '/' . $item['filename']);
			SpoonFile::delete($basePath . '/' . BackendModel::getModuleSetting('agenda', 'width2') . 'x' . BackendModel::getModuleSetting('agenda', 'height2') . '/' . $item['filename']);
			SpoonFile::delete($basePath . '/' . BackendModel::getModuleSetting('agenda', 'width3') . 'x' . BackendModel::getModuleSetting('agenda', 'height3') . '/' . $item['filename']);
		}
	}
